<template>
  <v-container grid-list-xl>
    <v-btn class="v-btn--back-link" @click="back()">Back to Account</v-btn>
    <v-card>
      <h2>Privacy Policy</h2>
      <hr />

<p>NuStrength Pty Ltd understands that your privacy is important to you. We are committed to protecting the privacy of your personally-identifiable information as you use this website. This Privacy Policy tells you how we protect and use information that we gather from you. By using this website, you consent to the terms described in the most recent version of this Privacy Policy. You should also read our Terms of Use to understand the general rules about your use of this website, and any additional terms that may apply when you access particular services or materials on certain areas of this website. “We,” “our” means NuStrength PTY LTD and its affiliates. “You,” “your,” visitor,” or “user” means the individual accessing this site.
</p>
...
<h3>DOES NUSTRENGTH PTY LTD SHARE PERSONAL INFORMATION WITH OTHERS?</h3>
...
<p>We collect information regarding you and your use of our service, your interactions with us and our advertising, as well as information regarding your computer or other device used to access our service.
</p>
<h3>THIS INFORMATION INCLUDES:</h3>
<ol>
<li>Your activity on our platform such as course progress and search queries</li>

<li>Details regarding your interactions with customer service such as the date, time and reason for contacting us</li>

<li>Transcripts of any chat conversations that you initiate on our platforms</li>

<li>In the event that you initiate phone support, your phone number</li>

<li>Device IDs or unique identifiers, device and software characteristics (such as type and configuration)</li>

<li>Connection information, statistics on page views, referral URLs, IP address, and standard web log information</li>

<li>Information collected via the use of cookies, web beacons and other technologies, including ad data (such as information on impressions delivered to a cookie, the site URL where the impression was delivered, as well as the date and time).
</li>
</ol>
<p>We use the information we collect to provide, analyse, administer, enhance, and personalise our services and marketing efforts, to process your registration, your orders, your payments, and your communication on these and other topics.
</p>
<p>Our primary aim is always to enhance the user experience. We do so in several ways using the data that we collect, but a few examples are: determining your general platform usage, required action item completions, login details, etc. which then helps us know what difficulties the you’re facing within the platform, with which can then use to take action to minimise the effort on your end. We collect other information, such as most visited links on our website, which then help us conclude what content was most watched, enabling us to create additional content geared toward our users’ needs and personal preferences.
</p>
<h3>LINKS</h3>
<p>This site contains links to other sites that provide information that we consider to be interesting. NuStrength PTY LTD is not responsible for the privacy practices or the content of such web sites.
</p>
<h3>PUBLIC DISCUSSIONS</h3>
<p>This site may provide public discussions on various business valuation topics. Please note that any information you post in these discussions will become public, so please do not post sensitive information in the public discussions. Whenever you publicly disclose information online, that information could be collected and used by others. We are not responsible for any action or policies of any third parties who collect information that users disclose in any such forums on the web site. The One Percent PTY LTD does not agree or disagree with anything posted on the discussion board. Also remember that you must comply with our other published policies regarding postings on our public forums.
</p>
<h3>HOW CAN A USER ACCESS, CHANGE, AND/OR DELETE PERSONAL INFORMATION?</h3>
<p>You may access, correct, update, and/or delete any personally-identifiable information that you submit to the web site. You may also unsubscribe from mailing lists or any registrations on the web site. To do so, please either follow instructions on the page of the web site on which you have provided such information or subscribed or registered or contact us at [info@nustrength.com.au]
</p>
<h3>CHILDREN’S PRIVACY</h3>
<p>NuStrength PTY LTD will not intentionally collect any personal information (such as a child’s name or email address) from children under the age of 13. If you think that we have collected personal information from a child under the age of 13, please contact us.
</p>
<h3>CHANGES</h3>
<p>NuStrength PTY LTD reserves the right to modify this statement at any time. Any changes to this Privacy Policy will be listed in this section, and if such changes are material, a notice will be included on the homepage of the web site for a period of time. If you have any questions about privacy at any websites operated by NuStrength PTY LTD or about our website practices, please contact us at: info@nustrength.com.au.
</p>
