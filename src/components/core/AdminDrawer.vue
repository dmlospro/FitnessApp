...
import toBeReviewed from "@/api/to-be-reviewed"
import { users } from "@/api/messages"
...
export default {
  ...
  data() {
    return {
      ...
      overlap: false,
      loading: false,
      group_sel: null, //TODO: there should be single dropdown in the UI
      group_sel2: null,
  ...
  methods: {
    ...
    groupFilter(items, groupId, filter) {
