<template>
  <v-card class="mt-3 meal-section">
    ...
    <v-container>
      ...
      <v-layout v-for="(meal, index) in meals" :key="index" wrap align-center v-if="isMobile" class="mobile-section">
        ...
        <v-flex xs12>
          <template>
            <v-layout v-for="(intake, i) in meal.selectedIntakes" :key="i" row wrap>
              ...
              <v-flex xs5 class="slider"> <v-slider readonly v-model="totals[index][i]['weight'].slice(0, -1)"></v-slider> </v-flex>
            </v-layout>
          </template>
        </v-flex>
      ...
      <v-layout v-for="(meal, index) in meals" :key="index" wrap align-center v-else>
        ...
        <v-flex xs8 md9>
          <template>
            <v-layout v-for="(intake, i) in meal.selectedIntakes"
              :key="i">
